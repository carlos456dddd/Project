...
<body>
    ...
    <article>
        ...
        <div class="form_empleados">
            ...
            <form action="" method="POST">
                <table class="table_form">
                    ...
                    <tr>
                    <td><label for="id_form">Area:</label></td>
                    <td><select name="area_form" id="area_form">
                        <?php
                            $consulta = "SELECT * FROM rrhh.area";
                            $rpta = sqlsrv_query($con, $consulta);
                            while($fila_area = sqlsrv_fetch_array($rpta)){
                                echo "<option value='".$fila_area['idArea']."'>".$fila_area['nombreArea']."</option>";
                            }
                        ?>
                    </select></td>
                    <td><label for="id_form">Sede:</label></td>
                    <td><select name="sede_form" id="sede_form">
                        <?php
                            $consulta = "SELECT * FROM rrhh.sede s inner join rrhh.area a on s.idArea=a.idArea";
                            $rpta = sqlsrv_query($con, $consulta);
                            while($fila_sede = sqlsrv_fetch_array($rpta)){
                                echo "<option value='".$fila_sede['idSede']."'>".$fila_sede['distrito']." (".$fila_sede['nombreArea'].")</option>";
                            }
                        ?>
                    </select></td>
                    <tr>
                ...
                <input type="submit" class="btn_enviar" name="btn_enviar" value="Enviar">
            </form>
            <?php
                ...
                if(isset($_POST['btn_enviar'])){
                    ...
                    //2 opc. El id está lleno: Se actualiza empleado
                        ...
                        idSeguro='$seguro', idArea='$area',idSede='$sede' WHERE idEmpleado = $id";
                    }
        ...
        <div class="imagen_form">
            <img src="image/empleado.png" alt="">
        </div>
        </div>
        <div class="tab_empleados">
            ...
            <tr>
                ...
                while($f_empleado = sqlsrv_fetch_array($rpta)){
                    ...
                    <td><?php echo $f_empleado['nombresEmpleado']; ?></td>
                    <td><?php echo $f_empleado['apellidosEmpleado']; ?></td>
                ...
                if (isset($_POST['btn_eliminar'])){
                    ...
                    $sql = "DELETE FROM rrhh.empleado WHERE idEmpleado = ".$id;
                    $rpta = sqlsrv_query($con, $sql);
                    if(!$rpta){
                        echo "ERROR!.";
                    }
